...
module.exports = function (env) {
	...
	return {
		...
		output: {
			...
			publicPath: isProd ? `//i1.${_isUle ? 'ulecdn' : 'beta.ule'}.com/app/yzg/dhh/` : '/',
			// 添加 chunkFilename
		...
		resolve: {
			...
			alias: {
				...
				'@types' : resolve('src/action/ActionsType'),
				'@goodsAction' : resolve('src/action/Goods'),
				'@action' : resolve('src/action'),
				'@public' : resolve('src/public'),
				'@url' : resolve('src/core/RequestAddress')
			}
		},
		plugins,
